...
namespace HRMS.Admin.API.Migrations
{
    ...
    [Migration("20220901103712_DepartmentDL")]
    partial class DepartmentDL
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.Activity", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.ActivityType", b =>
                {
                    b.Property<int>("ActivityTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.AllMenus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.ClientsHistory", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.CompetencySkill", b =>
                {
                    b.Property<int>("CompetencySkillId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.DepartmentDL", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("DLEmailAdress")
                        .IsRequired()
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.ExitType", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.FinancialYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.GradeRoleType", b =>
                {
                    ...
                    b.HasKey("GradeRoleTypeId");

                    b.HasIndex("GradeId");

                    b.HasIndex("RoleTypeId", "GradeId")
                        .IsUnique();

                    b.ToTable("GradeRoleType");
                });

            modelBuilder.Entity("HRMS.Admin.Entities.MenuMaster", b =>
                {
                    b.Property<int>("MenuId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.MenuRole", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.Reason", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.ReasonType", b =>
                {
                    b.Property<int>("ReasonTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.RoleType", b =>
                {
                    b.Property<int>("RoleTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.ServiceDepartmentRole", b =>
                {
                    b.Property<int>("ServiceDepartmentRoleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("ServiceDepartmentRoleId");

                    b.ToTable("ServiceDepartmentRoles");
                });

            modelBuilder.Entity("HRMS.Admin.Entities.ServiceType", b =>
                {
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.Activity", b =>
                {
                    b.HasOne("HRMS.Admin.Entities.ActivityType", "ActivityType")
                        .WithMany("Activities")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.CompetencySkill", b =>
                {
                    b.HasOne("HRMS.Admin.Entities.CompetencyArea", "CompetencyArea")
                        .WithMany("CompetencySkills")
                        .HasForeignKey("CompetencyAreaId");

                    b.HasOne("HRMS.Admin.Entities.ProficiencyLevel", "ProficiencyLevel")
                        .WithMany("CompetencySkills")
                        .HasForeignKey("ProficiencyLevelId")
                        .IsRequired();

                    b.HasOne("HRMS.Admin.Entities.RoleMaster", "RoleMaster")
                        .WithMany("CompetencySkills")
                    ...
                    b.HasOne("HRMS.Admin.Entities.Skill", "Skill")
                        .WithMany("CompetencySkills")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.GradeRoleType", b =>
                {
                    b.HasOne("HRMS.Admin.Entities.Grade", "Grades")
                        .WithMany("GradeRoleTypes")
                        .HasForeignKey("GradeId")
                        .IsRequired();

                    b.HasOne("HRMS.Admin.Entities.RoleType", "RoleTypes")
                        .WithMany("GradeRoleTypes")
            ...
            modelBuilder.Entity("HRMS.Admin.Entities.Reason", b =>
                {
                    b.HasOne("HRMS.Admin.Entities.ReasonType", "ReasonType")
                        .WithMany("Reasons")
