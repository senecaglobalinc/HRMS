...
namespace HRMS.Employee.Entities
{
    public class Employee : BaseEntity
    {
        ...
        public virtual ICollection<AssociateResignation> AssociateResignations { get; set; }
        public virtual ICollection<AssociateLongLeave> AssociateLongLeaves { get; set; }
