...
import { TokenexpirywarningDialogComponent } from '../auth/components/tokenexpirywarning-dialog/tokenexpirywarning-dialog.component'

@NgModule({
  declarations: [LoginComponent, AuthCallbackComponent, TokenexpirywarningDialogComponent],
  imports: [
    CommonModule,
    RouterModule,
