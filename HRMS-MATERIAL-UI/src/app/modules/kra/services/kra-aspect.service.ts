...
import 'rxjs/Rx';
import { AspectData, KraAspectData } from 'src/app/modules/master-layout/models/kra.model'; 
...
export class KraAspectService {
  ...
  private _serverURL: string;
    ...
    constructor(private _http: HttpClient) { this._serverURL = environment.KRAMicroService;
