...
export class Associate_Allocation_NonBillable {
    constructor() {
        ...
        //this.Client                   = 'input[formcontrolname="ClientId"]'
         ...
         //this.Billable                = 'input[formcontrolname="ClientBillingRoleName"]'
    ...
    AssociateAllocationNonBillable(config) {
        ...
        if (AssociateName) {
            ...
            cy.contains('span', "Billable").click({force: true})//comment this line if associate allocated for billable project
            cy.wait(2000)
            //cy.contains('span', "Primary").click({force: true})//comment this line if associate allocated for billable project
            cy.wait(2000)
        ...
        if (ReportingManager) {
            ...
            cy.contains('span.mat-option-text', ReportingManager).click() 
            cy.contains('span', "Primary").click({force: true})
